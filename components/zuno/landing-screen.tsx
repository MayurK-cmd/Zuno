...
export function LandingScreen({ onStart }: LandingScreenProps) {
  ...
  return (
    <div className="flex h-full w-full flex-col items-center justify-center overflow-y-auto px-4 py-10">
      ...
      <div className="w-full max-w-md">
        <div className="rounded-xl border border-cyan-500/20 bg-gradient-to-b from-slate-800/50 to-slate-900/50 p-6 backdrop-blur-xl sm:p-8">
          ...
          <div className="mb-6 rounded-lg border border-cyan-500/20 bg-slate-950/70 p-4">
