  ...
  head: () => ({
    meta: [
      ...
      { title: "Zuno — Zero-Knowledge Uno on Stellar" },
      {
        name: "description",
        content:
          "Play Uno on Stellar with cryptographic proofs that your hand is real. Fast, trustless, private gameplay.",
      },
      { property: "og:title", content: "Zuno — Zero-Knowledge Uno on Stellar" },
      {
        property: "og:description",
        content: "Cosmic, high-stakes card game powered by Stellar and zero-knowledge proofs.",
      },
  ...
  return (
    <QueryClientProvider client={queryClient}>
      ...
      <Toaster
        ...
        toastOptions={{
          style: {
            background: "oklch(0.17 0.03 270 / 0.85)",
